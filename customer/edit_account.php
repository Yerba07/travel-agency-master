...
<head>
    <meta charset="UTF-8">
    <title>Редактировать учетную запись</title>
...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <table align="center" width="750">
            ...
            <tr align="center">
                <td colspan="6"><input type="submit" name="update" value="Обновить учетную запись"></td>
            </tr>
        </table>
    </form>
...
if (isset($_POST['update'])) {
    ...
    if ($run_update) {
        echo "<script>alert('Ваша учетная запись успешно обновлена!')</script>";
