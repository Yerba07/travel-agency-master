...
<body bgcolor="skyblue">
    <form action="" method="post" enctype="multipart/form-data">
        <table align="center" width="795" border=2px bgcolor="ABB3C8">
            <tr align="center">
                <td colspan="7"><h2 style="font-family: Cambria; margin-top: 20px; margin-bottom: 15px;">Редактировать и Обновить Пакет</h2></td>
            </tr>
            <tr>
                <td align="right"><b>Название Пакета:</b></td>
                <td><input type="text" name="package_title" size="60" value="<?php echo $pack_title; ?>"></td>
            </tr>
            <tr>
                <td align="right"><b>Категория Пакета:</b></td>
                <td>
            ...
            <tr>
                <td align="right"><b>Тип Пакета:</b></td>
                <td>
            ...
            <tr>
                <td align="right"><b>Изображение Пакета:</b></td>
                <td>
...
if (isset($_POST['update_package'])) {
    ...
    if ($run_pack) {
        echo "<script>alert('Пакет успешно обновлен!')</script>";
