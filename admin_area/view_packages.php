...
if (!isset($_SESSION['user_email'])) {
    ...
    <body>
        <table width="795" align="center" bgcolor="#EAD2AC">
            <tr align="center">
                <td colspan="6"><h2 style="font-family: Cambria; margin-top: 10px; margin-bottom: 5px;">Посмотреть все пакеты можно здесь</h2></td>
            </tr>
            <tr align="center" bgcolor="#5FCEE8">
                <th id="thfix">Sl.</th>
                <th id="thfix">Заглавие</th>
            ...
            while ($row_pack = mysqli_fetch_array($run_pack)) {
                ...
                <tr align="center">
                    ...
                    <td><a href="index.php?edit_pack=<?php echo $pack_id; ?>">Редактировать</a></td>
                    <td><a href="delete_pack.php?delete_pack=<?php echo $pack_id; ?>">Удалить</a></td>
                    <td></td>
                </tr>
                <?php
            }
