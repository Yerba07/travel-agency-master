...
<body bgcolor="skyblue">
    <form action="insert_package.php" method="post" enctype="multipart/form-data">
        <table align="center" width="795" border=2px bgcolor="ABB3C8">
            <tr align="center">
                <td colspan="7"><h2 style="font-family: Cambria;margin-top: 20px; margin-bottom: 15px;">Вставьте новый пакет здесь</h2>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="right"><b>Стоимость пакета:</b></td>
            ...
            <tr align="center">
                <td colspan="7"><input style="margin-top: 10px; margin-bottom: 15px;" type="submit"
                                       name="insert_post" value="Вставить пакет"></td>
            </tr>
        </table>
    </form>
</body>
