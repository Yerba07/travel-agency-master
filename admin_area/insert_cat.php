...
if (!isset($_SESSION['user_email'])) {
    ...
    <head>
        <meta charset="UTF-8">
        <title>Вставить категорию</title>
        <style type="text/css">
            b {
                font-family: arial;
                font-size: 18px;
    ...
    <body>
        <form action="" method="post" style="padding: 80px;">
            <table align="center">
                <tr>
                    <td align="left"><b>Вставить новую категорию:</b></td>
                ...
                <tr>
                    <td></td>
                    <td align="right"><input id="btn" type="submit" name="add_cat" value="Добавить категорию"></td>
                </tr>
            </table>
        </form>
