...
<head>
    <meta charset="UTF-8">
    <title>Travel Bird : Корзина</title>
            ...
            <div id="content_area">
                ...
                <div id="shopping_cart">
                    <span style="float: right;font-size: 18px;padding: 5px;line-height: 40px;">
                        ...
                        ?>
                        <b style="color: yellow;">Корзина</b> Общее количество товаров: <?php total_items(); ?>
                        Итоговая цена: <?php total_price(); ?>
                        <a href="index.php" style="color: yellow;">В корзину</a>
                        <?php
                        if (!isset($_SESSION['customer_email'])) {
                ...
                <div id="packages_box">
                    <form action="" method="post" enctype="multipart/form-data">
                        <table align="center" width="700px" bgcolor="skyblue">
                            ...
                            <tr align="center">
                                <td colspan="2"><input type="submit" name="update_cart" value="Обновить корзину"></td>
                                <td><input type="submit" name="continue" value="Продолжить покупку"></td>
                                <td>
