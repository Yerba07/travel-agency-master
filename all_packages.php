...
<head>
    <meta charset="UTF-8">
    <title>Travel Bird : Все пакеты услуг</title>
            ...
            <div id="content_area">
                <div id="shopping_cart">
                    <span style="float: right;font-size: 18px;padding: 5px;line-height: 40px;">Добро пожаловать гость! <b
                                style="color: yellow;">Корзина покупок-</b> Общее количество товаров: Общая цена: <a href="cart.php"
                                                                                                       style="color: yellow;">Перейти к корзине</a></b></span>
                </div>
                <div id="packages_box">
                    <?php
                    ...
                    while ($row_pack = mysqli_fetch_array($run_pack)) {
                        ...
                        <p><b> Стоимость $ $pack_price</b></p>
                        <a href='details.php?pack_id=$pack_id' style='float: left; font-size:18px;text-decoration: none;'>Детали</a>
                        <a href='index.php?pack_id=$pack_id'><button style='float: right; font-size:14px; cursor: pointer; padding: 2px 4px;'>Выбрать</button></a>
                        </div>
                        ";
                    }
                    ?>
