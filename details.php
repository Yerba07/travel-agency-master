...
<head>
    <meta charset="UTF-8">
    <title>Travel Bird : Подробности</title>
            ...
            <div id="content_area">
                <div id="shopping_cart">
                    <span style="float: right;font-size: 18px;padding: 5px;line-height: 40px;">Добро пожаловать гость! <b
                                style="color: yellow;">Корзина-</b> Общее количество товаров: Общая цена: <a href="cart.php"
                ...
                <div id="packages_box">
                    ...
                    if (isset($_GET['pack_id'])) {
                        ...
                        while ($row_pack = mysqli_fetch_array($run_pack)) {
                            ...
                            <a href='index.php?pack_id=$pack_id'><button style='float: right;font-size:16px; cursor: pointer; padding: 2px 4px; margin:2px;'>Выбрать</button></a>
                            </div>
                            ";
                        }
                    }
